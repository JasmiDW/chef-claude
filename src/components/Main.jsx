    ...
    return (
        <>
            ...
            {ingredients.length > 0 && 
                <section>
                    <h2>Liste des ingrédients possédés:</h2>
                    <ul className="ingredients-list" aria-live="polite">{ingredientsListItems}</ul>
                    {ingredients.length >= 4 &&
                        <div className="get-recipe-container">
                            <div>
                                <h3>Prêt pour une recette?</h3>
                                <p>Génère une recette à partir des ingrédients possédés.</p>
                            </div>
                            <button onClick={handleRecipe}>{recipeShown ? 'Cacher la' : 'Montrer une'} recette</button>
                        </div> 
                    }
                </section>
            }
